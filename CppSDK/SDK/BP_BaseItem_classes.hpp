...
public:
	...
	class USphereComponent*                       DetectSphere;                                      // 0x02C8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         EntityId;                                          // 0x02E0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_BaseItem_C) == 0x0002E8, "Wrong size on ABP_BaseItem_C");
...
static_assert(offsetof(ABP_BaseItem_C, DetectSphere) == 0x0002C8, "Member 'ABP_BaseItem_C::DetectSphere' has a wrong offset!");
static_assert(offsetof(ABP_BaseItem_C, StaticMesh) == 0x0002D0, "Member 'ABP_BaseItem_C::StaticMesh' has a wrong offset!");
static_assert(offsetof(ABP_BaseItem_C, Scene) == 0x0002D8, "Member 'ABP_BaseItem_C::Scene' has a wrong offset!");
static_assert(offsetof(ABP_BaseItem_C, EntityId) == 0x0002E0, "Member 'ABP_BaseItem_C::EntityId' has a wrong offset!");

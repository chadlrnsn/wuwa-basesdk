...
{
public:
	class UMaterialInstanceDynamic*               None;                                              // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             None_0;                                            // 0x0000(0x0094)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUIItem*                                None_4;                                            // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         None_5;                                            // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         None_6;                                            // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FSCameraConfig                         None_9;                                            // 0x0000(0x0738)(HasGetValueTypeHash)
...
static_assert(offsetof(FPropertyMetaRoot, None_20) == 0x000000, "Member 'FPropertyMetaRoot::None_20' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1CB0[0x10];                                    // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};

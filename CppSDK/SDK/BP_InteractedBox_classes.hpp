...
static_assert(sizeof(ABP_InteractedBox_C) == 0x000310, "Wrong size on ABP_InteractedBox_C");
...
static_assert(offsetof(ABP_InteractedBox_C, PhysicsHandle) == 0x0002F8, "Member 'ABP_InteractedBox_C::PhysicsHandle' has a wrong offset!");
static_assert(offsetof(ABP_InteractedBox_C, HandleGrab) == 0x000300, "Member 'ABP_InteractedBox_C::HandleGrab' has a wrong offset!");
static_assert(offsetof(ABP_InteractedBox_C, ReleaseTimeHandle) == 0x000308, "Member 'ABP_InteractedBox_C::ReleaseTimeHandle' has a wrong offset!");

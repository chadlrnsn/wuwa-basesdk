...
public:
	...
	class UBodySetup*                             ProcMeshBodySetup;                                 // 0x0548(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FBoxSphereBounds                       LocalBounds;                                       // 0x0570(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_58C[0x4];                                      // 0x058C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBodySetup*>                     AsyncBodySetupQueue;                               // 0x0590(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UProceduralMeshComponent, AsyncBodySetupQueue) == 0x000590, "Member 'UProceduralMeshComponent::AsyncBodySetupQueue' has a wrong offset!");

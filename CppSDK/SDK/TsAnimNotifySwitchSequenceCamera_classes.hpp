...
static_assert(offsetof(UTsAnimNotifySwitchSequenceCamera_C, _y______4Mn) == 0x0000C8, "Member 'UTsAnimNotifySwitchSequenceCamera_C::_y______4Mn' has a wrong offset!");
static_assert(offsetof(UTsAnimNotifySwitchSequenceCamera_C, Y______4Mn) == 0x0000D0, "Member 'UTsAnimNotifySwitchSequenceCamera_C::Y______4Mn' has a wrong offset!");

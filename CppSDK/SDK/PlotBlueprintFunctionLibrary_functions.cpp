...
void UPlotBlueprintFunctionLibrary_C::PlaySpineAnimForGender(const class FString& MaleSpineName1, const class FString& FemaleSpineName1, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;
...
void UPlotBlueprintFunctionLibrary_C::PlaySpineAnim(const class FString& SpineName, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;

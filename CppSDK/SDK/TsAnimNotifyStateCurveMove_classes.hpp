...
public:
	...
	struct FSSkillBehaviorAction                  位置修正配置;                                      // 0x00B8(0x0268)(Edit, BlueprintVisible, HasGetValueTypeHash)
	class UCurveFloat*                            运动位置曲线;                                      // 0x0320(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FSplinePoint>                   运动轨迹曲线关键点;                                // 0x0328(0x0010)(Edit, BlueprintVisible)
	TArray<struct FInterpCurvePointFloat>         运动轨迹曲线插值ReparamTable;                      // 0x0338(0x0010)(Edit, BlueprintVisible)
	EMovementProcessDirection                     运动过程朝向;                                      // 0x0348(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          DebugMode;                                         // 0x0349(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          自动更新运动轨迹曲线关键点;                        // 0x034A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(UTsAnimNotifyStateCurveMove_C) == 0x000350, "Wrong size on UTsAnimNotifyStateCurveMove_C");
...
static_assert(offsetof(UTsAnimNotifyStateCurveMove_C, 运动位置曲线) == 0x000320, "Member 'UTsAnimNotifyStateCurveMove_C::运动位置曲线' has a wrong offset!");
static_assert(offsetof(UTsAnimNotifyStateCurveMove_C, 运动轨迹曲线关键点) == 0x000328, "Member 'UTsAnimNotifyStateCurveMove_C::运动轨迹曲线关键点' has a wrong offset!");
static_assert(offsetof(UTsAnimNotifyStateCurveMove_C, 运动轨迹曲线插值ReparamTable) == 0x000338, "Member 'UTsAnimNotifyStateCurveMove_C::运动轨迹曲线插值ReparamTable' has a wrong offset!");
static_assert(offsetof(UTsAnimNotifyStateCurveMove_C, 运动过程朝向) == 0x000348, "Member 'UTsAnimNotifyStateCurveMove_C::运动过程朝向' has a wrong offset!");
static_assert(offsetof(UTsAnimNotifyStateCurveMove_C, DebugMode) == 0x000349, "Member 'UTsAnimNotifyStateCurveMove_C::DebugMode' has a wrong offset!");
static_assert(offsetof(UTsAnimNotifyStateCurveMove_C, 自动更新运动轨迹曲线关键点) == 0x00034A, "Member 'UTsAnimNotifyStateCurveMove_C::自动更新运动轨迹曲线关键点' has a wrong offset!");

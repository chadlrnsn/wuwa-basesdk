...
static_assert(alignof(TsAnimNotifyStateNextAtt_C_K2_NotifyBegin) == 0x000008, "Wrong alignment on TsAnimNotifyStateNextAtt_C_K2_NotifyBegin");
static_assert(sizeof(TsAnimNotifyStateNextAtt_C_K2_NotifyBegin) == 0x000018, "Wrong size on TsAnimNotifyStateNextAtt_C_K2_NotifyBegin");
static_assert(offsetof(TsAnimNotifyStateNextAtt_C_K2_NotifyBegin, MeshComp) == 0x000000, "Member 'TsAnimNotifyStateNextAtt_C_K2_NotifyBegin::MeshComp' has a wrong offset!");
...
struct TsAnimNotifyStateNextAtt_C_GetNotifyName final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)
};
static_assert(alignof(TsAnimNotifyStateNextAtt_C_GetNotifyName) == 0x000008, "Wrong alignment on TsAnimNotifyStateNextAtt_C_GetNotifyName");
static_assert(sizeof(TsAnimNotifyStateNextAtt_C_GetNotifyName) == 0x000010, "Wrong size on TsAnimNotifyStateNextAtt_C_GetNotifyName");
static_assert(offsetof(TsAnimNotifyStateNextAtt_C_GetNotifyName, ReturnValue) == 0x000000, "Member 'TsAnimNotifyStateNextAtt_C_GetNotifyName::ReturnValue' has a wrong offset!");

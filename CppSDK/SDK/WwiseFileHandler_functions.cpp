...
// Function WwiseFileHandler.WwiseExternalSourceStatics.InitExternalSourceConfigs
// (Final, Native, Static, Public, BlueprintCallable)

void UWwiseExternalSourceStatics::InitExternalSourceConfigs()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("WwiseExternalSourceStatics", "InitExternalSourceConfigs");

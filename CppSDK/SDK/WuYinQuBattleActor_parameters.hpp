...
static_assert(alignof(WuYinQuBattleActor_C_ExecuteUbergraph_WuYinQuBattleActor) == 0x000004, "Wrong alignment on WuYinQuBattleActor_C_ExecuteUbergraph_WuYinQuBattleActor");

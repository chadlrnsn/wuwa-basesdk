...
public:
	...
	int32                                         DelayDisappearMillisecond;                         // 0x0080(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSLockOnFollowShooter                  LockOnConfig;                                      // 0x0084(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         AimType;                                           // 0x0094(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UBP_FollowShooterConfig_C) == 0x000098, "Wrong size on UBP_FollowShooterConfig_C");
...
static_assert(offsetof(UBP_FollowShooterConfig_C, DelayDisappearMillisecond) == 0x000080, "Member 'UBP_FollowShooterConfig_C::DelayDisappearMillisecond' has a wrong offset!");
static_assert(offsetof(UBP_FollowShooterConfig_C, LockOnConfig) == 0x000084, "Member 'UBP_FollowShooterConfig_C::LockOnConfig' has a wrong offset!");
static_assert(offsetof(UBP_FollowShooterConfig_C, AimType) == 0x000094, "Member 'UBP_FollowShooterConfig_C::AimType' has a wrong offset!");

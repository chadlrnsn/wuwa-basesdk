...
public:
	...
	uint8                                         Pad_4A5[0x7];                                      // 0x04A5(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	static void SetUIHierarchyIndex(class AActor* Target, int32 Index_0);
...
public:
	...
	uint8                                         Pad_22B[0x55];                                     // 0x022B(0x0055)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool                                          bAlignCenter;                                      // 0x081C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIgnoreWordRules;                                  // 0x081D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAutoEllipsis;                                     // 0x081E(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAutoEllipsisSplitWord;                            // 0x081F(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_8F1[0x10F];                                    // 0x08F1(0x010F)(Fixing Size After Last Property [ Dumper-7 ])
	class UUITextClickComponent*                  ClickComponent;                                    // 0x0A00(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A08[0x28];                                     // 0x0A08(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             OnSelfLanguageChange;                              // 0x0A30(0x0028)(Edit, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NativeAccessSpecifierPublic)
	TDelegate<void()>                             OnTextureAsyncLoaded;                              // 0x0A58(0x0028)(Edit, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NativeAccessSpecifierPublic)
	uint32                                        TranslateId;                                       // 0x0A80(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A84[0x24];                                     // 0x0A84(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bGameRichText;                                     // 0x0AA8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	int32 GetRenderLineCharNum(int32 Index_0);
...
static_assert(sizeof(UUIText) == 0x000AB0, "Wrong size on UUIText");
...
static_assert(offsetof(UUIText, bAlignCenter) == 0x00081C, "Member 'UUIText::bAlignCenter' has a wrong offset!");
static_assert(offsetof(UUIText, bIgnoreWordRules) == 0x00081D, "Member 'UUIText::bIgnoreWordRules' has a wrong offset!");
static_assert(offsetof(UUIText, bAutoEllipsis) == 0x00081E, "Member 'UUIText::bAutoEllipsis' has a wrong offset!");
static_assert(offsetof(UUIText, bAutoEllipsisSplitWord) == 0x00081F, "Member 'UUIText::bAutoEllipsisSplitWord' has a wrong offset!");
...
static_assert(offsetof(UUIText, ClickComponent) == 0x000A00, "Member 'UUIText::ClickComponent' has a wrong offset!");
static_assert(offsetof(UUIText, OnSelfLanguageChange) == 0x000A30, "Member 'UUIText::OnSelfLanguageChange' has a wrong offset!");
static_assert(offsetof(UUIText, OnTextureAsyncLoaded) == 0x000A58, "Member 'UUIText::OnTextureAsyncLoaded' has a wrong offset!");
static_assert(offsetof(UUIText, TranslateId) == 0x000A80, "Member 'UUIText::TranslateId' has a wrong offset!");
static_assert(offsetof(UUIText, bGameRichText) == 0x000AA8, "Member 'UUIText::bGameRichText' has a wrong offset!");
...
{
public:
	bool                                          IsUIDrawCallVisible;                               // 0x06B0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsSupportWorldSpace;                               // 0x06B1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6B2[0x1E];                                     // 0x06B2(0x001E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULGUINiagaraComponent) == 0x0006D0, "Wrong size on ULGUINiagaraComponent");
static_assert(offsetof(ULGUINiagaraComponent, IsUIDrawCallVisible) == 0x0006B0, "Member 'ULGUINiagaraComponent::IsUIDrawCallVisible' has a wrong offset!");
static_assert(offsetof(ULGUINiagaraComponent, IsSupportWorldSpace) == 0x0006B1, "Member 'ULGUINiagaraComponent::IsSupportWorldSpace' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_15C[0x74];                                     // 0x015C(0x0074)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_238[0x2];                                      // 0x0238(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_589[0x17];                                     // 0x0589(0x0017)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5A8[0x200];                                    // 0x05A8(0x0200)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3C8[0x90];                                     // 0x03C8(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_6E8[0xF0];                                     // 0x06E8(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UUIItem*                                Parent;                                            // 0x04F0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UBodySetup*                             BodySetup;                                         // 0x04F8(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UUIItemEditorHelperComp, Parent) == 0x0004F0, "Member 'UUIItemEditorHelperComp::Parent' has a wrong offset!");
static_assert(offsetof(UUIItemEditorHelperComp, BodySetup) == 0x0004F8, "Member 'UUIItemEditorHelperComp::BodySetup' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4FC[0x8C];                                     // 0x04FC(0x008C)(Fixing Size After Last Property [ Dumper-7 ])

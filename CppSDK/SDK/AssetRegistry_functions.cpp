...
bool IAssetRegistry::IsPathForceScanned(const class FString& InPath)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AssetRegistry", "IsPathForceScanned");
...
bool IAssetRegistry::IsPathsForceScanned(const TArray<class FString>& InPaths)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AssetRegistry", "IsPathsForceScanned");
...
bool IAssetRegistry::IsAssetPathLoaded(class FString* Path) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AssetRegistry", "IsAssetPathLoaded");

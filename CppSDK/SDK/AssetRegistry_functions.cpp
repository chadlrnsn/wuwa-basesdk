...
bool IAssetRegistry::IsPathForceScanned(const class FString& InPath)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("AssetRegistry", "IsPathForceScanned");

	Params::AssetRegistry_IsPathForceScanned Parms{};
...
bool IAssetRegistry::IsPathsForceScanned(const TArray<class FString>& InPaths)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("AssetRegistry", "IsPathsForceScanned");

	Params::AssetRegistry_IsPathsForceScanned Parms{};
...
// const TArray<class FString>&            InPaths                                                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// bool                                    bForceRescan                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    bIgnoreBlackListScanFilters                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    bUseParallelScan                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void IAssetRegistry::ScanPathsSynchronous(const TArray<class FString>& InPaths, bool bForceRescan, bool bIgnoreBlackListScanFilters, bool bUseParallelScan)
{
	static class UFunction* Func = nullptr;
	...
	Parms.InPaths = std::move(InPaths);
	Parms.bForceRescan = bForceRescan;
	Parms.bIgnoreBlackListScanFilters = bIgnoreBlackListScanFilters;
	Parms.bUseParallelScan = bUseParallelScan;
...
bool IAssetRegistry::IsAssetPathLoaded(class FString* Path) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("AssetRegistry", "IsAssetPathLoaded");

	Params::AssetRegistry_IsAssetPathLoaded Parms{};

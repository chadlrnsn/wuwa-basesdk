...
static_assert(offsetof(UKuroDebugMovementComponent, DrawDebugCount) == 0x0004F8, "Member 'UKuroDebugMovementComponent::DrawDebugCount' has a wrong offset!");
static_assert(offsetof(UKuroDebugMovementComponent, bDrawDebug) == 0x0004FD, "Member 'UKuroDebugMovementComponent::bDrawDebug' has a wrong offset!");
...
public:
	...
	static bool KuroSoar(float DeltaSeconds, class UCharacterMovementComponent* CharMoveComp, float AirFriction, float Aerodynamics, const struct FVector& Gravity, const struct FVector& SoarPlaneNormal, float MaxSpeed);

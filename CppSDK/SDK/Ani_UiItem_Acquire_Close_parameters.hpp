...
{
public:
	class AUIContainerActor*                      UiItem_Acquire;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(SequenceDirector_C_SequenceEvent__ENTRYPOINTSequenceDirector_0, UiItem_Acquire) == 0x000000, "Member 'SequenceDirector_C_SequenceEvent__ENTRYPOINTSequenceDirector_0::UiItem_Acquire' has a wrong offset!");

// Function Ani_UiItem_Acquire_Close.SequenceDirector_C.UiItem_Acquire_Event_0
// 0x0028 (0x0028 - 0x0000)
struct SequenceDirector_C_UiItem_Acquire_Event_0 final
{
public:
	class AUIContainerActor*                      UiItem_Acquire;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(SequenceDirector_C_UiItem_Acquire_Event_0) == 0x000008, "Wrong alignment on SequenceDirector_C_UiItem_Acquire_Event_0");
static_assert(sizeof(SequenceDirector_C_UiItem_Acquire_Event_0) == 0x000028, "Wrong size on SequenceDirector_C_UiItem_Acquire_Event_0");
static_assert(offsetof(SequenceDirector_C_UiItem_Acquire_Event_0, UiItem_Acquire) == 0x000000, "Member 'SequenceDirector_C_UiItem_Acquire_Event_0::UiItem_Acquire' has a wrong offset!");
static_assert(offsetof(SequenceDirector_C_UiItem_Acquire_Event_0, sequenceName) == 0x000008, "Member 'SequenceDirector_C_UiItem_Acquire_Event_0::sequenceName' has a wrong offset!");
static_assert(offsetof(SequenceDirector_C_UiItem_Acquire_Event_0, eventName) == 0x000018, "Member 'SequenceDirector_C_UiItem_Acquire_Event_0::eventName' has a wrong offset!");
...
public:
	...
	class AUIContainerActor*                      K2Node_CustomEvent_UiItem_Acquire;                 // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(SequenceDirector_C_ExecuteUbergraph_SequenceDirector, K2Node_CustomEvent_UiItem_Acquire) == 0x000008, "Member 'SequenceDirector_C_ExecuteUbergraph_SequenceDirector::K2Node_CustomEvent_UiItem_Acquire' has a wrong offset!");

...
public:
	...
	static void PlaySpineAnimForGender(const class FString& MaleSpineName1, const class FString& FemaleSpineName1, class UObject* __WorldContext);
	static void PlaySpineAnim(const class FString& SpineName, class UObject* __WorldContext);

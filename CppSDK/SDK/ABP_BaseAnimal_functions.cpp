...
// Parameters:
// float                                   Param_ActionTime                                       (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UABP_BaseAnimal_C::GetCurrentActionTime(float* Param_ActionTime)
{
	...
	if (Param_ActionTime != nullptr)
		*Param_ActionTime = Parms.Param_ActionTime;
}
...
void UABP_BaseAnimal_C::__B(const struct FPoseLink& ____e, struct FPoseLink* Param___B)
{
	static class UFunction* Func = nullptr;
...
// struct FPoseLink                        Param____B                                             (Parm, OutParm, NoDestructor)

void UABP_BaseAnimal_C::___B(const struct FPoseLink& ___e, struct FPoseLink* Param____B)
{
	static class UFunction* Func = nullptr;
	...
	if (Param____B != nullptr)
		*Param____B = std::move(Parms.Param____B);
}
...
void UABP_BaseAnimal_C::__B_0(struct FPoseLink* Param___B)
{
	static class UFunction* Func = nullptr;
...
void UABP_BaseAnimal_C::AnimGraph(struct FPoseLink* Param_AnimGraph)
{
	static class UFunction* Func = nullptr;

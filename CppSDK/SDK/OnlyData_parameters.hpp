...
public:
	...
	bool                                          isFind;                                            // 0x0018(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSReBulletDataMain                     BulletData;                                        // 0x0020(0x0760)(Parm, OutParm, HasGetValueTypeHash)
	class FName                                   CallFunc_Conv_StringToName_ReturnValue;            // 0x0780(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_78C[0x4];                                      // 0x078C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSReBulletDataMain                     CallFunc_GetDataTableRowFromName_OutRow;           // 0x0790(0x0760)(HasGetValueTypeHash)
	bool                                          CallFunc_GetDataTableRowFromName_ReturnValue;      // 0x0EF0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(OnlyData_C_GetCommonNewBulletData) == 0x000008, "Wrong alignment on OnlyData_C_GetCommonNewBulletData");
static_assert(sizeof(OnlyData_C_GetCommonNewBulletData) == 0x000EF8, "Wrong size on OnlyData_C_GetCommonNewBulletData");
...
static_assert(offsetof(OnlyData_C_GetCommonNewBulletData, CallFunc_Conv_StringToName_ReturnValue) == 0x000780, "Member 'OnlyData_C_GetCommonNewBulletData::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(OnlyData_C_GetCommonNewBulletData, CallFunc_GetDataTableRowFromName_OutRow) == 0x000790, "Member 'OnlyData_C_GetCommonNewBulletData::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(OnlyData_C_GetCommonNewBulletData, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000EF0, "Member 'OnlyData_C_GetCommonNewBulletData::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");

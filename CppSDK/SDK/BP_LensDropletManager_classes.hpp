...
static_assert(sizeof(ABP_LensDropletManager_C) == 0x000370, "Wrong size on ABP_LensDropletManager_C");
...
static_assert(offsetof(ABP_LensDropletManager_C, PrezCamVec) == 0x000334, "Member 'ABP_LensDropletManager_C::PrezCamVec' has a wrong offset!");
static_assert(offsetof(ABP_LensDropletManager_C, CurrCamPos) == 0x000340, "Member 'ABP_LensDropletManager_C::CurrCamPos' has a wrong offset!");
static_assert(offsetof(ABP_LensDropletManager_C, CurrCamVec) == 0x00034C, "Member 'ABP_LensDropletManager_C::CurrCamVec' has a wrong offset!");
static_assert(offsetof(ABP_LensDropletManager_C, SpawnSpeed) == 0x000358, "Member 'ABP_LensDropletManager_C::SpawnSpeed' has a wrong offset!");
static_assert(offsetof(ABP_LensDropletManager_C, RainType) == 0x00035C, "Member 'ABP_LensDropletManager_C::RainType' has a wrong offset!");
static_assert(offsetof(ABP_LensDropletManager_C, MaxNumber) == 0x000360, "Member 'ABP_LensDropletManager_C::MaxNumber' has a wrong offset!");
static_assert(offsetof(ABP_LensDropletManager_C, Delta_Seconds) == 0x000364, "Member 'ABP_LensDropletManager_C::Delta_Seconds' has a wrong offset!");
static_assert(offsetof(ABP_LensDropletManager_C, Is_in_Cave) == 0x000368, "Member 'ABP_LensDropletManager_C::Is_in_Cave' has a wrong offset!");

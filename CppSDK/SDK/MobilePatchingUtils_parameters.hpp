...
public:
	...
	uint8                                         Pad_26F7[0x7];                                     // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(MobilePendingContent_StartInstall, OnFailed) == 0x000028, "Member 'MobilePendingContent_StartInstall::OnFailed' has a wrong offset!");
...
static_assert(offsetof(MobilePatchingLibrary_RequestContent, OnFailed) == 0x000058, "Member 'MobilePatchingLibrary_RequestContent::OnFailed' has a wrong offset!");

...
public:
	...
	uint8                                         Pad_3075[0x7];                                     // 0x02C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void __Spine__(const class FString& SpineName);
	void __Spine____Plus_(const class FString& MaleSpineName1, const class FString& FemaleSpineName1);

...
#include "TsAnimNotifyStateRunRotateBoneToLocation_classes.hpp"
#include "TsAnimNotifyStateRunRotateBoneToLocation_parameters.hpp"
...
bool UTsAnimNotifyStateRunRotateBoneToLocation_C::K2_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TsAnimNotifyStateRunRotateBoneToLocation_C", "K2_NotifyEnd");

	Params::TsAnimNotifyStateRunRotateBoneToLocation_C_K2_NotifyEnd Parms{};
...
class FString UTsAnimNotifyStateRunRotateBoneToLocation_C::GetNotifyName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TsAnimNotifyStateRunRotateBoneToLocation_C", "GetNotifyName");

	Params::TsAnimNotifyStateRunRotateBoneToLocation_C_GetNotifyName Parms{};

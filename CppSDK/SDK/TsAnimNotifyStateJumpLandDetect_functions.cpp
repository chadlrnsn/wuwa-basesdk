...
#include "TsAnimNotifyStateJumpLandDetect_classes.hpp"
#include "TsAnimNotifyStateJumpLandDetect_parameters.hpp"
...
bool UTsAnimNotifyStateJumpLandDetect_C::K2_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TsAnimNotifyStateJumpLandDetect_C", "K2_NotifyEnd");

	Params::TsAnimNotifyStateJumpLandDetect_C_K2_NotifyEnd Parms{};
...
class FString UTsAnimNotifyStateJumpLandDetect_C::GetNotifyName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TsAnimNotifyStateJumpLandDetect_C", "GetNotifyName");

	Params::TsAnimNotifyStateJumpLandDetect_C_GetNotifyName Parms{};

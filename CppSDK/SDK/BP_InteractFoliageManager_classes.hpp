...
static_assert(sizeof(ABP_InteractFoliageManager_C) == 0x000310, "Wrong size on ABP_InteractFoliageManager_C");
...
static_assert(offsetof(ABP_InteractFoliageManager_C, Active) == 0x000300, "Member 'ABP_InteractFoliageManager_C::Active' has a wrong offset!");

...
static_assert(alignof(TsAnimNotifySwitchSequenceCamera_C_K2_Notify) == 0x000008, "Wrong alignment on TsAnimNotifySwitchSequenceCamera_C_K2_Notify");
static_assert(sizeof(TsAnimNotifySwitchSequenceCamera_C_K2_Notify) == 0x000018, "Wrong size on TsAnimNotifySwitchSequenceCamera_C_K2_Notify");
...
// 0x0010 (0x0010 - 0x0000)
struct TsAnimNotifySwitchSequenceCamera_C_GetNotifyName final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)
};
static_assert(alignof(TsAnimNotifySwitchSequenceCamera_C_GetNotifyName) == 0x000008, "Wrong alignment on TsAnimNotifySwitchSequenceCamera_C_GetNotifyName");
static_assert(sizeof(TsAnimNotifySwitchSequenceCamera_C_GetNotifyName) == 0x000010, "Wrong size on TsAnimNotifySwitchSequenceCamera_C_GetNotifyName");
static_assert(offsetof(TsAnimNotifySwitchSequenceCamera_C_GetNotifyName, ReturnValue) == 0x000000, "Member 'TsAnimNotifySwitchSequenceCamera_C_GetNotifyName::ReturnValue' has a wrong offset!");

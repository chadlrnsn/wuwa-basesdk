...
public:
	...
	uint8                                         Pad_2CB2[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CB3[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                __WorldContext;                                    // 0x0010(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                         Pad_2CB6[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CB8[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(PlotBlueprintFunctionLibrary_C_PlaySpineAnimForGender) == 0x000028, "Wrong size on PlotBlueprintFunctionLibrary_C_PlaySpineAnimForGender");
static_assert(offsetof(PlotBlueprintFunctionLibrary_C_PlaySpineAnimForGender, MaleSpineName1) == 0x000000, "Member 'PlotBlueprintFunctionLibrary_C_PlaySpineAnimForGender::MaleSpineName1' has a wrong offset!");
static_assert(offsetof(PlotBlueprintFunctionLibrary_C_PlaySpineAnimForGender, FemaleSpineName1) == 0x000010, "Member 'PlotBlueprintFunctionLibrary_C_PlaySpineAnimForGender::FemaleSpineName1' has a wrong offset!");
static_assert(offsetof(PlotBlueprintFunctionLibrary_C_PlaySpineAnimForGender, __WorldContext) == 0x000020, "Member 'PlotBlueprintFunctionLibrary_C_PlaySpineAnimForGender::__WorldContext' has a wrong offset!");
...
static_assert(sizeof(PlotBlueprintFunctionLibrary_C_PlaySpineAnim) == 0x000018, "Wrong size on PlotBlueprintFunctionLibrary_C_PlaySpineAnim");
static_assert(offsetof(PlotBlueprintFunctionLibrary_C_PlaySpineAnim, SpineName) == 0x000000, "Member 'PlotBlueprintFunctionLibrary_C_PlaySpineAnim::SpineName' has a wrong offset!");
static_assert(offsetof(PlotBlueprintFunctionLibrary_C_PlaySpineAnim, __WorldContext) == 0x000010, "Member 'PlotBlueprintFunctionLibrary_C_PlaySpineAnim::__WorldContext' has a wrong offset!");

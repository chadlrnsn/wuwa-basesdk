...
void UKuroVehicleMovementComponent::HandlePassiveVehicleImpact(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("KuroVehicleMovementComponent", "HandlePassiveVehicleImpact");

	Params::KuroVehicleMovementComponent_HandlePassiveVehicleImpact Parms{};

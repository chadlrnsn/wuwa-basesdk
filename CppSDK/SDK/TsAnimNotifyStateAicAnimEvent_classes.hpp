...
{
public:
	class FName                                   Name_TsAnimNotifyStateAicAnimEvent_C;              // 0x0048(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UTsAnimNotifyStateAicAnimEvent_C, Name_TsAnimNotifyStateAicAnimEvent_C) == 0x000048, "Member 'UTsAnimNotifyStateAicAnimEvent_C::Name_TsAnimNotifyStateAicAnimEvent_C' has a wrong offset!");

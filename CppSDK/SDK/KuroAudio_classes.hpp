...
static_assert(sizeof(UKuroAmbientSoundPositionsProxyComponent) == 0x000660, "Wrong size on UKuroAmbientSoundPositionsProxyComponent");
static_assert(offsetof(UKuroAmbientSoundPositionsProxyComponent, TargetComponent) == 0x000650, "Member 'UKuroAmbientSoundPositionsProxyComponent::TargetComponent' has a wrong offset!");

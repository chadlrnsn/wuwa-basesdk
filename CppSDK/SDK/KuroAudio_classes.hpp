...
{
public:
	class UKuroAmbientSoundComponent*             TargetComponent;                                   // 0x0660(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UKuroAmbientSoundPositionsProxyComponent) == 0x000670, "Wrong size on UKuroAmbientSoundPositionsProxyComponent");
static_assert(offsetof(UKuroAmbientSoundPositionsProxyComponent, TargetComponent) == 0x000660, "Member 'UKuroAmbientSoundPositionsProxyComponent::TargetComponent' has a wrong offset!");

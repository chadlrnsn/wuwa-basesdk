...
public:
	...
	static int32 SpawnEffect(class UObject* WorldContext, class UObject* CallObject, const class FString& Path, const struct FTransform& Transform, const class FString& Reason, EEffectPlay PlayType, bool DisablePostProcess, class UObject* __WorldContext);

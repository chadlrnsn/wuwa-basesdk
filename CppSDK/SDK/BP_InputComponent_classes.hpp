...
public:
	...
	bool                                          _____BP_InputComponent_C;                          // 0x0219(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(UBP_InputComponent_C, _____BP_InputComponent_C) == 0x000219, "Member 'UBP_InputComponent_C::_____BP_InputComponent_C' has a wrong offset!");

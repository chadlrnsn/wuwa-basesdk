...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Relax_Vision_C;                  // 0x0568(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Relax_Vision_C) == 0x000578, "Wrong size on UGA_Relax_Vision_C");
static_assert(offsetof(UGA_Relax_Vision_C, UberGraphFrame_GA_Relax_Vision_C) == 0x000568, "Member 'UGA_Relax_Vision_C::UberGraphFrame_GA_Relax_Vision_C' has a wrong offset!");
static_assert(offsetof(UGA_Relax_Vision_C, 召唤者) == 0x000570, "Member 'UGA_Relax_Vision_C::召唤者' has a wrong offset!");

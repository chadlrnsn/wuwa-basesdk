...
public:
	...
	class AUIContainerActor*                      K2Node_CustomEvent_UiItem_ItemBaseB;               // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AUIContainerActor*                      K2Node_CustomEvent_UiItem_ItemBaseB_1;             // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

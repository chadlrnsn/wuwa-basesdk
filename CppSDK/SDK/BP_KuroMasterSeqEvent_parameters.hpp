...
public:
	...
	uint8                                         Pad_3076[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_307A[0x3];                                     // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
// Function BP_KuroMasterSeqEvent.BP_KuroMasterSeqEvent_C.gLžS'‹ö
// 0x0018 (0x0018 - 0x0000)
struct BP_KuroMasterSeqEvent_C_GL_S___ final
{
public:
	class FString                                 Key;                                               // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
static_assert(alignof(BP_KuroMasterSeqEvent_C_GL_S___) == 0x000008, "Wrong alignment on BP_KuroMasterSeqEvent_C_GL_S___");
static_assert(sizeof(BP_KuroMasterSeqEvent_C_GL_S___) == 0x000018, "Wrong size on BP_KuroMasterSeqEvent_C_GL_S___");
static_assert(offsetof(BP_KuroMasterSeqEvent_C_GL_S___, Key) == 0x000000, "Member 'BP_KuroMasterSeqEvent_C_GL_S___::Key' has a wrong offset!");
static_assert(offsetof(BP_KuroMasterSeqEvent_C_GL_S___, EntityId) == 0x000010, "Member 'BP_KuroMasterSeqEvent_C_GL_S___::EntityId' has a wrong offset!");

// Function BP_KuroMasterSeqEvent.BP_KuroMasterSeqEvent_C.­>Spine¨;
// 0x0010 (0x0010 - 0x0000)
struct BP_KuroMasterSeqEvent_C___Spine__ final
{
public:
	class FString                                 SpineName;                                         // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_KuroMasterSeqEvent_C___Spine__) == 0x000008, "Wrong alignment on BP_KuroMasterSeqEvent_C___Spine__");
static_assert(sizeof(BP_KuroMasterSeqEvent_C___Spine__) == 0x000010, "Wrong size on BP_KuroMasterSeqEvent_C___Spine__");
static_assert(offsetof(BP_KuroMasterSeqEvent_C___Spine__, SpineName) == 0x000000, "Member 'BP_KuroMasterSeqEvent_C___Spine__::SpineName' has a wrong offset!");

// Function BP_KuroMasterSeqEvent.BP_KuroMasterSeqEvent_C.­>Spine¨;('+)
// 0x0020 (0x0020 - 0x0000)
struct BP_KuroMasterSeqEvent_C___Spine____Plus_ final
{
public:
...
static_assert(alignof(BP_KuroMasterSeqEvent_C___Spine____Plus_) == 0x000008, "Wrong alignment on BP_KuroMasterSeqEvent_C___Spine____Plus_");
static_assert(sizeof(BP_KuroMasterSeqEvent_C___Spine____Plus_) == 0x000020, "Wrong size on BP_KuroMasterSeqEvent_C___Spine____Plus_");
static_assert(offsetof(BP_KuroMasterSeqEvent_C___Spine____Plus_, MaleSpineName1) == 0x000000, "Member 'BP_KuroMasterSeqEvent_C___Spine____Plus_::MaleSpineName1' has a wrong offset!");
static_assert(offsetof(BP_KuroMasterSeqEvent_C___Spine____Plus_, FemaleSpineName1) == 0x000010, "Member 'BP_KuroMasterSeqEvent_C___Spine____Plus_::FemaleSpineName1' has a wrong offset!");

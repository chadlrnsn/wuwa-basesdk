...
{
public:
	uint8                                         Pad_1CB2[0x20];                                    // 0x05D0(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1CB3[0x78];                                    // 0x0030(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1CB4[0x3];                                     // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	float                                         ReportDeoptFrameInfoThreshold;                     // 0x008C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableMinorGCInTick;                               // 0x0090(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnablePreloadJS;                                   // 0x0091(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableCheckLauncherJs;                             // 0x0092(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableV8Print;                                     // 0x0093(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableGCHeapLayoutTrace;                           // 0x0094(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableGCHeapStatsTrace;                            // 0x0095(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          UseRelativeScriptOrigin;                           // 0x0096(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          JsAbsPathSupportPak;                               // 0x0097(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableV8DeoptimizeTrace;                           // 0x0098(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableV8RuntimeTrace;                              // 0x0099(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableV8TracingController;                         // 0x009A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableV8PriorityMode;                              // 0x009B(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1CB5[0x4];                                     // 0x009C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UJsEnvSetting, ReportDeoptFrameInfoThreshold) == 0x00008C, "Member 'UJsEnvSetting::ReportDeoptFrameInfoThreshold' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnableMinorGCInTick) == 0x000090, "Member 'UJsEnvSetting::EnableMinorGCInTick' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnablePreloadJS) == 0x000091, "Member 'UJsEnvSetting::EnablePreloadJS' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnableCheckLauncherJs) == 0x000092, "Member 'UJsEnvSetting::EnableCheckLauncherJs' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnableV8Print) == 0x000093, "Member 'UJsEnvSetting::EnableV8Print' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnableGCHeapLayoutTrace) == 0x000094, "Member 'UJsEnvSetting::EnableGCHeapLayoutTrace' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnableGCHeapStatsTrace) == 0x000095, "Member 'UJsEnvSetting::EnableGCHeapStatsTrace' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, UseRelativeScriptOrigin) == 0x000096, "Member 'UJsEnvSetting::UseRelativeScriptOrigin' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, JsAbsPathSupportPak) == 0x000097, "Member 'UJsEnvSetting::JsAbsPathSupportPak' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnableV8DeoptimizeTrace) == 0x000098, "Member 'UJsEnvSetting::EnableV8DeoptimizeTrace' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnableV8RuntimeTrace) == 0x000099, "Member 'UJsEnvSetting::EnableV8RuntimeTrace' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnableV8TracingController) == 0x00009A, "Member 'UJsEnvSetting::EnableV8TracingController' has a wrong offset!");
static_assert(offsetof(UJsEnvSetting, EnableV8PriorityMode) == 0x00009B, "Member 'UJsEnvSetting::EnableV8PriorityMode' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1CB6[0x20];                                    // 0x0338(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1CB7[0x20];                                    // 0x00E8(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1CB8[0x20];                                    // 0x0378(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1CB9[0x69];                                    // 0x0338(0x0069)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1CBA[0x6];                                     // 0x03A2(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])

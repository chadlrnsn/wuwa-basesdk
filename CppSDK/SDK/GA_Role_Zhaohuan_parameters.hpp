...
static_assert(alignof(GA_Role_Zhaohuan_C_ExecuteUbergraph_GA_Role_Zhaohuan) == 0x000008, "Wrong alignment on GA_Role_Zhaohuan_C_ExecuteUbergraph_GA_Role_Zhaohuan");
static_assert(sizeof(GA_Role_Zhaohuan_C_ExecuteUbergraph_GA_Role_Zhaohuan) == 0x000018, "Wrong size on GA_Role_Zhaohuan_C_ExecuteUbergraph_GA_Role_Zhaohuan");
static_assert(offsetof(GA_Role_Zhaohuan_C_ExecuteUbergraph_GA_Role_Zhaohuan, EntryPoint) == 0x000000, "Member 'GA_Role_Zhaohuan_C_ExecuteUbergraph_GA_Role_Zhaohuan::EntryPoint' has a wrong offset!");

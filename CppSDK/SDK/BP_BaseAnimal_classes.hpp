...
static_assert(sizeof(ABP_BaseAnimal_C) == 0x000790, "Wrong size on ABP_BaseAnimal_C");
static_assert(offsetof(ABP_BaseAnimal_C, TurnSpeedCurve) == 0x000788, "Member 'ABP_BaseAnimal_C::TurnSpeedCurve' has a wrong offset!");

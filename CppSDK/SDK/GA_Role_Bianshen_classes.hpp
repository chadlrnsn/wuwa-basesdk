...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Role_Bianshen_C;                 // 0x0568(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Role_Bianshen_C) == 0x000570, "Wrong size on UGA_Role_Bianshen_C");
static_assert(offsetof(UGA_Role_Bianshen_C, UberGraphFrame_GA_Role_Bianshen_C) == 0x000568, "Member 'UGA_Role_Bianshen_C::UberGraphFrame_GA_Role_Bianshen_C' has a wrong offset!");

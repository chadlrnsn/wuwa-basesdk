...
public:
	...
	uint8                                         Pad_121[0x147];                                    // 0x0121(0x0147)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_113[0x15];                                     // 0x0113(0x0015)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_160[0x1B0];                                    // 0x0160(0x01B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_136[0xCA];                                     // 0x0136(0x00CA)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	TArray<struct FKuroRotateBonePart>            Parts;                                             // 0x00D8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FString, float>                    ActivateBoneMap;                                   // 0x00E8(0x0050)(BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVector                                TargetPosition;                                    // 0x0138(0x000C)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_144[0x6C];                                     // 0x0144(0x006C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_KuroRotateBonesToTarget) == 0x000008, "Wrong alignment on FAnimNode_KuroRotateBonesToTarget");
static_assert(sizeof(FAnimNode_KuroRotateBonesToTarget) == 0x0001B0, "Wrong size on FAnimNode_KuroRotateBonesToTarget");
static_assert(offsetof(FAnimNode_KuroRotateBonesToTarget, Parts) == 0x0000D8, "Member 'FAnimNode_KuroRotateBonesToTarget::Parts' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroRotateBonesToTarget, ActivateBoneMap) == 0x0000E8, "Member 'FAnimNode_KuroRotateBonesToTarget::ActivateBoneMap' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroRotateBonesToTarget, TargetPosition) == 0x000138, "Member 'FAnimNode_KuroRotateBonesToTarget::TargetPosition' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_FC[0xD4];                                      // 0x00FC(0x00D4)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_144[0x2FC];                                    // 0x0144(0x02FC)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_FB[0x15];                                      // 0x00FB(0x0015)(Fixing Struct Size After Last Property [ Dumper-7 ])
};

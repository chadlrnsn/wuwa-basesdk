...
{
public:
	struct FSkeletonGroup                         SkeletonBlockInfo;                                 // 0x00D8(0x0020)(Edit, NativeAccessSpecifierPublic)
	float                                         DeltaTime;                                         // 0x00F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         UnitTime;                                          // 0x00FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Hit;                                               // 0x0100(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          NotEffectToChild;                                  // 0x0101(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B32[0x2];                                     // 0x0102(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ShakeRate;                                         // 0x0104(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FHitBones                              HitBoneNames;                                      // 0x0108(0x0010)(Edit, NativeAccessSpecifierPublic)
	class UCurveFloat*                            Curve;                                             // 0x0118(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDebug;                                            // 0x0120(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B33[0x147];                                   // 0x0121(0x0147)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_Feedback) == 0x000008, "Wrong alignment on FAnimNode_Feedback");
static_assert(sizeof(FAnimNode_Feedback) == 0x000268, "Wrong size on FAnimNode_Feedback");
static_assert(offsetof(FAnimNode_Feedback, SkeletonBlockInfo) == 0x0000D8, "Member 'FAnimNode_Feedback::SkeletonBlockInfo' has a wrong offset!");
static_assert(offsetof(FAnimNode_Feedback, DeltaTime) == 0x0000F8, "Member 'FAnimNode_Feedback::DeltaTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_Feedback, UnitTime) == 0x0000FC, "Member 'FAnimNode_Feedback::UnitTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_Feedback, Hit) == 0x000100, "Member 'FAnimNode_Feedback::Hit' has a wrong offset!");
static_assert(offsetof(FAnimNode_Feedback, NotEffectToChild) == 0x000101, "Member 'FAnimNode_Feedback::NotEffectToChild' has a wrong offset!");
static_assert(offsetof(FAnimNode_Feedback, ShakeRate) == 0x000104, "Member 'FAnimNode_Feedback::ShakeRate' has a wrong offset!");
static_assert(offsetof(FAnimNode_Feedback, HitBoneNames) == 0x000108, "Member 'FAnimNode_Feedback::HitBoneNames' has a wrong offset!");
static_assert(offsetof(FAnimNode_Feedback, Curve) == 0x000118, "Member 'FAnimNode_Feedback::Curve' has a wrong offset!");
static_assert(offsetof(FAnimNode_Feedback, bDebug) == 0x000120, "Member 'FAnimNode_Feedback::bDebug' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1B34[0x7];                                     // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B35[0x7];                                     // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B36[0xE0];                                    // 0x00D8(0x00E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	class FName                                   BoneName;                                          // 0x00D8(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnAngle;                                         // 0x00E4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LookUpAngle;                                       // 0x00E8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                ForwardLocation;                                   // 0x00EC(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              TurnLimit;                                         // 0x00F8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              LookUpLimit;                                       // 0x0100(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LookUpOffset;                                      // 0x0108(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnUpOffset;                                      // 0x010C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRollBackToOrigin;                                 // 0x0110(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStopRoll;                                         // 0x0111(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDebug;                                            // 0x0112(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B37[0x15];                                    // 0x0113(0x0015)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_BoneRotateToLocation) == 0x000008, "Wrong alignment on FAnimNode_BoneRotateToLocation");
static_assert(sizeof(FAnimNode_BoneRotateToLocation) == 0x000128, "Wrong size on FAnimNode_BoneRotateToLocation");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, BoneName) == 0x0000D8, "Member 'FAnimNode_BoneRotateToLocation::BoneName' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, TurnAngle) == 0x0000E4, "Member 'FAnimNode_BoneRotateToLocation::TurnAngle' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, LookUpAngle) == 0x0000E8, "Member 'FAnimNode_BoneRotateToLocation::LookUpAngle' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, ForwardLocation) == 0x0000EC, "Member 'FAnimNode_BoneRotateToLocation::ForwardLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, TurnLimit) == 0x0000F8, "Member 'FAnimNode_BoneRotateToLocation::TurnLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, LookUpLimit) == 0x000100, "Member 'FAnimNode_BoneRotateToLocation::LookUpLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, LookUpOffset) == 0x000108, "Member 'FAnimNode_BoneRotateToLocation::LookUpOffset' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, TurnUpOffset) == 0x00010C, "Member 'FAnimNode_BoneRotateToLocation::TurnUpOffset' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, bRollBackToOrigin) == 0x000110, "Member 'FAnimNode_BoneRotateToLocation::bRollBackToOrigin' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, bStopRoll) == 0x000111, "Member 'FAnimNode_BoneRotateToLocation::bStopRoll' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneRotateToLocation, bDebug) == 0x000112, "Member 'FAnimNode_BoneRotateToLocation::bDebug' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1B38[0x3];                                     // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B39[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B3A[0x8];                                     // 0x0058(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1B3B[0xA40];                                   // 0x0010(0x0A40)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	TArray<struct FBoneReference>                 BeginBones;                                        // 0x00D8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FBoneReference>                 EndBones;                                          // 0x00E8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FBoneReference>                 WeakenBones;                                       // 0x00F8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FBoneReference                         RootBone;                                          // 0x0108(0x0014)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	float                                         MaxTurnAngle;                                      // 0x011C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Weaken;                                            // 0x0120(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RecoveryWeaken;                                    // 0x0124(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinDistance;                                       // 0x0128(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDistance;                                       // 0x012C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AnimChangeOptizimeParameter;                       // 0x0130(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          NewHit;                                            // 0x0134(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B3C[0x3];                                     // 0x0135(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                HitPos;                                            // 0x0138(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                HitVector;                                         // 0x0144(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FeedbackTimeLength;                                // 0x0150(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B3D[0x4];                                     // 0x0154(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveFloat*                            Curve;                                             // 0x0158(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B3E[0x1B0];                                   // 0x0160(0x01B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_FeedbackRotate) == 0x000008, "Wrong alignment on FAnimNode_FeedbackRotate");
static_assert(sizeof(FAnimNode_FeedbackRotate) == 0x000310, "Wrong size on FAnimNode_FeedbackRotate");
static_assert(offsetof(FAnimNode_FeedbackRotate, BeginBones) == 0x0000D8, "Member 'FAnimNode_FeedbackRotate::BeginBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, EndBones) == 0x0000E8, "Member 'FAnimNode_FeedbackRotate::EndBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, WeakenBones) == 0x0000F8, "Member 'FAnimNode_FeedbackRotate::WeakenBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, RootBone) == 0x000108, "Member 'FAnimNode_FeedbackRotate::RootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, MaxTurnAngle) == 0x00011C, "Member 'FAnimNode_FeedbackRotate::MaxTurnAngle' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, Weaken) == 0x000120, "Member 'FAnimNode_FeedbackRotate::Weaken' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, RecoveryWeaken) == 0x000124, "Member 'FAnimNode_FeedbackRotate::RecoveryWeaken' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, MinDistance) == 0x000128, "Member 'FAnimNode_FeedbackRotate::MinDistance' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, MaxDistance) == 0x00012C, "Member 'FAnimNode_FeedbackRotate::MaxDistance' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, AnimChangeOptizimeParameter) == 0x000130, "Member 'FAnimNode_FeedbackRotate::AnimChangeOptizimeParameter' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, NewHit) == 0x000134, "Member 'FAnimNode_FeedbackRotate::NewHit' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, HitPos) == 0x000138, "Member 'FAnimNode_FeedbackRotate::HitPos' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, HitVector) == 0x000144, "Member 'FAnimNode_FeedbackRotate::HitVector' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, FeedbackTimeLength) == 0x000150, "Member 'FAnimNode_FeedbackRotate::FeedbackTimeLength' has a wrong offset!");
static_assert(offsetof(FAnimNode_FeedbackRotate, Curve) == 0x000158, "Member 'FAnimNode_FeedbackRotate::Curve' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1B3F[0x68];                                    // 0x00C0(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	EKuroAnimIKMode                               bMode;                                             // 0x00EC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B40[0x3];                                     // 0x00ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   BaseAngleCurveName;                                // 0x00F0(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B41[0x4];                                     // 0x00FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 LocationCurveName;                                 // 0x0100(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                IKLocalPos;                                        // 0x0110(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LowerLimit[0x2];                                   // 0x011C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                OffsetOrTargetPosition;                            // 0x0124(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EndBoneIKMode                                 bEndBoneMode;                                      // 0x0130(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B42[0x3];                                     // 0x0131(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                EndBoneBaseAxis;                                   // 0x0134(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                EndBoneTargetAxis;                                 // 0x0140(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B43[0x4];                                     // 0x014C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B44[0x48];                                    // 0x0178(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, IKBone) == 0x0000D8, "Member 'FAnimNode_HumanTwoBoneIK::IKBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, bMode) == 0x0000EC, "Member 'FAnimNode_HumanTwoBoneIK::bMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, BaseAngleCurveName) == 0x0000F0, "Member 'FAnimNode_HumanTwoBoneIK::BaseAngleCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, LocationCurveName) == 0x000100, "Member 'FAnimNode_HumanTwoBoneIK::LocationCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, IKLocalPos) == 0x000110, "Member 'FAnimNode_HumanTwoBoneIK::IKLocalPos' has a wrong offset!");
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, LowerLimit) == 0x00011C, "Member 'FAnimNode_HumanTwoBoneIK::LowerLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, OffsetOrTargetPosition) == 0x000124, "Member 'FAnimNode_HumanTwoBoneIK::OffsetOrTargetPosition' has a wrong offset!");
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, bEndBoneMode) == 0x000130, "Member 'FAnimNode_HumanTwoBoneIK::bEndBoneMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, EndBoneBaseAxis) == 0x000134, "Member 'FAnimNode_HumanTwoBoneIK::EndBoneBaseAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_HumanTwoBoneIK, EndBoneTargetAxis) == 0x000140, "Member 'FAnimNode_HumanTwoBoneIK::EndBoneTargetAxis' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1B45[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B47[0x6];                                     // 0x006A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	TArray<struct FKuroHumanIKPart>               FootParts;                                         // 0x00D8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FKuroHumanIKPart>               HandParts;                                         // 0x00E8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	EKuroHumanIKMode                              Mode;                                              // 0x00F8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B48[0x3];                                     // 0x00F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CapsuleRadius;                                     // 0x00FC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsMoving;                                         // 0x0100(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsComplexIk;                                      // 0x0101(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B49[0x2];                                     // 0x0102(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DeltaSeconds;                                      // 0x0104(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForbiddenCurvePosition;                           // 0x0108(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bNoLerp;                                           // 0x0109(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B4A[0x2];                                     // 0x010A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GroundDepth;                                       // 0x010C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxIKFootDetectDepth;                              // 0x0110(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MovingSpeed;                                       // 0x0114(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WalkRunMix;                                        // 0x0118(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DegMovementSlop;                                   // 0x011C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ClimbRadius;                                       // 0x0120(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SlideForward;                                      // 0x0124(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SlideRadius;                                       // 0x0130(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStandSlide;                                       // 0x0134(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawDebug;                                        // 0x0135(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B4B[0xCA];                                    // 0x0136(0x00CA)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FAnimNode_KuroHumanIK, FootParts) == 0x0000D8, "Member 'FAnimNode_KuroHumanIK::FootParts' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, HandParts) == 0x0000E8, "Member 'FAnimNode_KuroHumanIK::HandParts' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, Mode) == 0x0000F8, "Member 'FAnimNode_KuroHumanIK::Mode' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, CapsuleRadius) == 0x0000FC, "Member 'FAnimNode_KuroHumanIK::CapsuleRadius' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, bIsMoving) == 0x000100, "Member 'FAnimNode_KuroHumanIK::bIsMoving' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, bIsComplexIk) == 0x000101, "Member 'FAnimNode_KuroHumanIK::bIsComplexIk' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, DeltaSeconds) == 0x000104, "Member 'FAnimNode_KuroHumanIK::DeltaSeconds' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, bForbiddenCurvePosition) == 0x000108, "Member 'FAnimNode_KuroHumanIK::bForbiddenCurvePosition' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, bNoLerp) == 0x000109, "Member 'FAnimNode_KuroHumanIK::bNoLerp' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, GroundDepth) == 0x00010C, "Member 'FAnimNode_KuroHumanIK::GroundDepth' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, MaxIKFootDetectDepth) == 0x000110, "Member 'FAnimNode_KuroHumanIK::MaxIKFootDetectDepth' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, MovingSpeed) == 0x000114, "Member 'FAnimNode_KuroHumanIK::MovingSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, WalkRunMix) == 0x000118, "Member 'FAnimNode_KuroHumanIK::WalkRunMix' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, DegMovementSlop) == 0x00011C, "Member 'FAnimNode_KuroHumanIK::DegMovementSlop' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, ClimbRadius) == 0x000120, "Member 'FAnimNode_KuroHumanIK::ClimbRadius' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, SlideForward) == 0x000124, "Member 'FAnimNode_KuroHumanIK::SlideForward' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, SlideRadius) == 0x000130, "Member 'FAnimNode_KuroHumanIK::SlideRadius' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, bStandSlide) == 0x000134, "Member 'FAnimNode_KuroHumanIK::bStandSlide' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, bDrawDebug) == 0x000135, "Member 'FAnimNode_KuroHumanIK::bDrawDebug' has a wrong offset!");
...
{
public:
	struct FBoneReference                         MountBone;                                         // 0x00D8(0x0014)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	float                                         PowerIntensity;                                    // 0x00EC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AirResistance;                                     // 0x00F0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MetaDeltaTime;                                     // 0x00F4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InertanceIntensity;                                // 0x00F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B4C[0xD4];                                    // 0x00FC(0x00D4)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FAnimNode_MountBuffer, MountBone) == 0x0000D8, "Member 'FAnimNode_MountBuffer::MountBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_MountBuffer, PowerIntensity) == 0x0000EC, "Member 'FAnimNode_MountBuffer::PowerIntensity' has a wrong offset!");
static_assert(offsetof(FAnimNode_MountBuffer, AirResistance) == 0x0000F0, "Member 'FAnimNode_MountBuffer::AirResistance' has a wrong offset!");
static_assert(offsetof(FAnimNode_MountBuffer, MetaDeltaTime) == 0x0000F4, "Member 'FAnimNode_MountBuffer::MetaDeltaTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_MountBuffer, InertanceIntensity) == 0x0000F8, "Member 'FAnimNode_MountBuffer::InertanceIntensity' has a wrong offset!");
...
public:
	struct FBoneReference                         IKBone;                                            // 0x00D8(0x0014)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                IKBonePos;                                         // 0x00EC(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBoneReference                         BeginBone;                                         // 0x00F8(0x0014)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBoneReference                         EndBone;                                           // 0x010C(0x0014)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	EKuroAnimIKMode                               bMode;                                             // 0x0120(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B4D[0x3];                                     // 0x0121(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                OffsetOrTargetPosition;                            // 0x0124(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B4E[0x20];                                    // 0x0130(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_MultiBonesIK) == 0x000008, "Wrong alignment on FAnimNode_MultiBonesIK");
static_assert(sizeof(FAnimNode_MultiBonesIK) == 0x000150, "Wrong size on FAnimNode_MultiBonesIK");
static_assert(offsetof(FAnimNode_MultiBonesIK, IKBone) == 0x0000D8, "Member 'FAnimNode_MultiBonesIK::IKBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_MultiBonesIK, IKBonePos) == 0x0000EC, "Member 'FAnimNode_MultiBonesIK::IKBonePos' has a wrong offset!");
static_assert(offsetof(FAnimNode_MultiBonesIK, BeginBone) == 0x0000F8, "Member 'FAnimNode_MultiBonesIK::BeginBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_MultiBonesIK, EndBone) == 0x00010C, "Member 'FAnimNode_MultiBonesIK::EndBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_MultiBonesIK, bMode) == 0x000120, "Member 'FAnimNode_MultiBonesIK::bMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_MultiBonesIK, OffsetOrTargetPosition) == 0x000124, "Member 'FAnimNode_MultiBonesIK::OffsetOrTargetPosition' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1B4F[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1B50[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B51[0x4];                                     // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	TArray<struct FPhyClothGroup>                 ClothGroups;                                       // 0x00D8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          OpenCollateralRotation;                            // 0x00E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          MultiThread;                                       // 0x00E9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Transport;                                         // 0x00EA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B52[0x1];                                     // 0x00EB(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TransportThreadHold;                               // 0x00EC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MinIterTimes;                                      // 0x00F0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxIterTimes;                                      // 0x00F4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDeltaTime;                                      // 0x00F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                WindSpeed;                                         // 0x00FC(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AirDrag;                                           // 0x0108(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DisturbPeriodic;                                   // 0x010C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DisturbStrMul;                                     // 0x0110(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B53[0x4];                                     // 0x0114(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveFloat*                            DisturbStr;                                        // 0x0118(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCurveFloat*                            DisturbSplit;                                      // 0x0120(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B54[0x10];                                    // 0x0128(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   OriginAlphaCurveName;                              // 0x0138(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B55[0x2FC];                                   // 0x0144(0x02FC)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FAnimNode_PhyCloth, ClothGroups) == 0x0000D8, "Member 'FAnimNode_PhyCloth::ClothGroups' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, OpenCollateralRotation) == 0x0000E8, "Member 'FAnimNode_PhyCloth::OpenCollateralRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, MultiThread) == 0x0000E9, "Member 'FAnimNode_PhyCloth::MultiThread' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, Transport) == 0x0000EA, "Member 'FAnimNode_PhyCloth::Transport' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, TransportThreadHold) == 0x0000EC, "Member 'FAnimNode_PhyCloth::TransportThreadHold' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, MinIterTimes) == 0x0000F0, "Member 'FAnimNode_PhyCloth::MinIterTimes' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, MaxIterTimes) == 0x0000F4, "Member 'FAnimNode_PhyCloth::MaxIterTimes' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, MaxDeltaTime) == 0x0000F8, "Member 'FAnimNode_PhyCloth::MaxDeltaTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, WindSpeed) == 0x0000FC, "Member 'FAnimNode_PhyCloth::WindSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, AirDrag) == 0x000108, "Member 'FAnimNode_PhyCloth::AirDrag' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, DisturbPeriodic) == 0x00010C, "Member 'FAnimNode_PhyCloth::DisturbPeriodic' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, DisturbStrMul) == 0x000110, "Member 'FAnimNode_PhyCloth::DisturbStrMul' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, DisturbStr) == 0x000118, "Member 'FAnimNode_PhyCloth::DisturbStr' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, DisturbSplit) == 0x000120, "Member 'FAnimNode_PhyCloth::DisturbSplit' has a wrong offset!");
static_assert(offsetof(FAnimNode_PhyCloth, OriginAlphaCurveName) == 0x000138, "Member 'FAnimNode_PhyCloth::OriginAlphaCurveName' has a wrong offset!");
...
{
public:
	int32                                         Increment;                                         // 0x00D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESightLockMode                                Mode;                                              // 0x00DC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B56[0x3];                                     // 0x00DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                SightDirectInSightBone;                            // 0x00E0(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                UpAxisInSightBone;                                 // 0x00EC(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SightBoneBaseEuler;                                // 0x00F8(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AssistRatio;                                       // 0x0104(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SightBoneLimit[0x4];                               // 0x0108(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AssistLimit;                                       // 0x0118(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                TargetDirect;                                      // 0x011C(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SightBoneName;                                     // 0x0128(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   BeginBoneName;                                     // 0x0134(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   EndBoneName;                                       // 0x0140(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B57[0x74];                                    // 0x014C(0x0074)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_SightLock) == 0x000008, "Wrong alignment on FAnimNode_SightLock");
static_assert(sizeof(FAnimNode_SightLock) == 0x0001C0, "Wrong size on FAnimNode_SightLock");
static_assert(offsetof(FAnimNode_SightLock, Increment) == 0x0000D8, "Member 'FAnimNode_SightLock::Increment' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, Mode) == 0x0000DC, "Member 'FAnimNode_SightLock::Mode' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, SightDirectInSightBone) == 0x0000E0, "Member 'FAnimNode_SightLock::SightDirectInSightBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, UpAxisInSightBone) == 0x0000EC, "Member 'FAnimNode_SightLock::UpAxisInSightBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, SightBoneBaseEuler) == 0x0000F8, "Member 'FAnimNode_SightLock::SightBoneBaseEuler' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, AssistRatio) == 0x000104, "Member 'FAnimNode_SightLock::AssistRatio' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, SightBoneLimit) == 0x000108, "Member 'FAnimNode_SightLock::SightBoneLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, AssistLimit) == 0x000118, "Member 'FAnimNode_SightLock::AssistLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, TargetDirect) == 0x00011C, "Member 'FAnimNode_SightLock::TargetDirect' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, SightBoneName) == 0x000128, "Member 'FAnimNode_SightLock::SightBoneName' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, BeginBoneName) == 0x000134, "Member 'FAnimNode_SightLock::BeginBoneName' has a wrong offset!");
static_assert(offsetof(FAnimNode_SightLock, EndBoneName) == 0x000140, "Member 'FAnimNode_SightLock::EndBoneName' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1B58[0x10];                                    // 0x0030(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B59[0x3];                                     // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B5A[0x8];                                     // 0x0050(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1B5B[0x50];                                    // 0x0030(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	struct FVector                                TargetLocation;                                    // 0x00D8(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B5C[0x4];                                     // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FSuiguangTailBoneConfig>        SuiguangTailBoneConfig;                            // 0x00E8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bRollBackToOrigin;                                 // 0x00F8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStopRoll;                                         // 0x00F9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDebug;                                            // 0x00FA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B5D[0x15];                                    // 0x00FB(0x0015)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_SuiguangTailRotate) == 0x000008, "Wrong alignment on FAnimNode_SuiguangTailRotate");
static_assert(sizeof(FAnimNode_SuiguangTailRotate) == 0x000110, "Wrong size on FAnimNode_SuiguangTailRotate");
static_assert(offsetof(FAnimNode_SuiguangTailRotate, TargetLocation) == 0x0000D8, "Member 'FAnimNode_SuiguangTailRotate::TargetLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_SuiguangTailRotate, SuiguangTailBoneConfig) == 0x0000E8, "Member 'FAnimNode_SuiguangTailRotate::SuiguangTailBoneConfig' has a wrong offset!");
static_assert(offsetof(FAnimNode_SuiguangTailRotate, bRollBackToOrigin) == 0x0000F8, "Member 'FAnimNode_SuiguangTailRotate::bRollBackToOrigin' has a wrong offset!");
static_assert(offsetof(FAnimNode_SuiguangTailRotate, bStopRoll) == 0x0000F9, "Member 'FAnimNode_SuiguangTailRotate::bStopRoll' has a wrong offset!");
static_assert(offsetof(FAnimNode_SuiguangTailRotate, bDebug) == 0x0000FA, "Member 'FAnimNode_SuiguangTailRotate::bDebug' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1B5E[0x3];                                     // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B60[0x4];                                     // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B61[0x18];                                    // 0x00B0(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};

...
public:
	...
	uint8                                         Pad_30F7[0x2];                                     // 0x0322(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          __yH_p;                                            // 0x032B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	float                                         __Iq_____;                                         // 0x032C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FSEffectFloatParameter>         _7_pFloat;                                         // 0x0330(0x0010)(Edit, BlueprintVisible)
	TArray<struct FSEffectColorParameter>         _7_pColor;                                         // 0x0340(0x0010)(Edit, BlueprintVisible)
	TArray<struct FSEffectVectorParameter>        _7_pVector;                                        // 0x0350(0x0010)(Edit, BlueprintVisible)
	TArray<struct FSEffectFloatParameter>         P__pFloat;                                         // 0x0360(0x0010)(Edit, BlueprintVisible)
	TArray<struct FSEffectColorParameter>         P__pColor;                                         // 0x0370(0x0010)(Edit, BlueprintVisible)
	TArray<struct FSEffectFloatParameter>         P__pFloat_Temp;                                    // 0x0380(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	...
	uint8                                         Pad_30F8[0x2];                                     // 0x0396(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         FloatParameter0;                                   // 0x0398(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash)
	float                                         FloatParameter1;                                   // 0x039C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash)
	float                                         FloatParameter2;                                   // 0x03A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash)
	bool                                          IsPublicToSequence;                                // 0x03A4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_30F9[0x3];                                     // 0x03A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 FloatParameterName0;                               // 0x03A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
	class FString                                 FloatParameterName1;                               // 0x03B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
	class FString                                 FloatParameterName2;                               // 0x03C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
	bool                                          IsSimulateFromSequence;                            // 0x03D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_30FA[0x3];                                     // 0x03D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CustomProcess;                                     // 0x03DC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ABP_EffectActor_C, __yH_p) == 0x00032B, "Member 'ABP_EffectActor_C::__yH_p' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, __Iq_____) == 0x00032C, "Member 'ABP_EffectActor_C::__Iq_____' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, _7_pFloat) == 0x000330, "Member 'ABP_EffectActor_C::_7_pFloat' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, _7_pColor) == 0x000340, "Member 'ABP_EffectActor_C::_7_pColor' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, _7_pVector) == 0x000350, "Member 'ABP_EffectActor_C::_7_pVector' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, P__pFloat) == 0x000360, "Member 'ABP_EffectActor_C::P__pFloat' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, P__pColor) == 0x000370, "Member 'ABP_EffectActor_C::P__pColor' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, P__pFloat_Temp) == 0x000380, "Member 'ABP_EffectActor_C::P__pFloat_Temp' has a wrong offset!");
...
static_assert(offsetof(ABP_EffectActor_C, FloatParameter0) == 0x000398, "Member 'ABP_EffectActor_C::FloatParameter0' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, FloatParameter1) == 0x00039C, "Member 'ABP_EffectActor_C::FloatParameter1' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, FloatParameter2) == 0x0003A0, "Member 'ABP_EffectActor_C::FloatParameter2' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, IsPublicToSequence) == 0x0003A4, "Member 'ABP_EffectActor_C::IsPublicToSequence' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, FloatParameterName0) == 0x0003A8, "Member 'ABP_EffectActor_C::FloatParameterName0' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, FloatParameterName1) == 0x0003B8, "Member 'ABP_EffectActor_C::FloatParameterName1' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, FloatParameterName2) == 0x0003C8, "Member 'ABP_EffectActor_C::FloatParameterName2' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, IsSimulateFromSequence) == 0x0003D8, "Member 'ABP_EffectActor_C::IsSimulateFromSequence' has a wrong offset!");
static_assert(offsetof(ABP_EffectActor_C, CustomProcess) == 0x0003DC, "Member 'ABP_EffectActor_C::CustomProcess' has a wrong offset!");

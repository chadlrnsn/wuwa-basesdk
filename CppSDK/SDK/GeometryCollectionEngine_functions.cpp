...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// EObjectStateTypeEnum                    type                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AGeometryCollectionActor::ChangeObjectTypeRuntime(EObjectStateTypeEnum type)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GeometryCollectionActor", "ChangeObjectTypeRuntime");

	Params::GeometryCollectionActor_ChangeObjectTypeRuntime Parms{};

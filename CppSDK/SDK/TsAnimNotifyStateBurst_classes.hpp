...
static_assert(offsetof(UTsAnimNotifyStateBurst_C, 不能切人) == 0x00004C, "Member 'UTsAnimNotifyStateBurst_C::不能切人' has a wrong offset!");
static_assert(offsetof(UTsAnimNotifyStateBurst_C, 是否无敌) == 0x00004D, "Member 'UTsAnimNotifyStateBurst_C::是否无敌' has a wrong offset!");

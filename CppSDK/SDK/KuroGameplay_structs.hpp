...
enum class EEffectModelGhostCppComponent : uint8
{
	...
	OtherCase3                               = 10,
	OtherCase4                               = 11,
	EEffectModelGhostCppComponent_MAX        = 12,
};
...
public:
	...
	uint8                                         Pad_1520[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1521[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1522[0x5C];                                    // 0x001C(0x005C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1523[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1524[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1525[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1526[0x6C];                                    // 0x001C(0x006C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};

...
public:
	...
	bool                                          bOverviewEnabled;                                  // 0x0055(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bOverviewEnabled) == 0x000055, "Member 'FNiagaraDebugHUDSettingsData::bOverviewEnabled' has a wrong offset!");

...
bool UKuroMovementBPLibrary::KuroSoar(float DeltaSeconds, class UCharacterMovementComponent* CharMoveComp, float AirFriction, float Aerodynamics, const struct FVector& Gravity, const struct FVector& SoarPlaneNormal, float MaxSpeed)
{
	static class UFunction* Func = nullptr;

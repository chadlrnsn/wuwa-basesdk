...
public:
	...
	class FString                                 MaterialPrefix1_不可修改_;                         // 0x0408(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
...
static_assert(offsetof(ABP_KposeBase_C, MaterialPrefix1_不可修改_) == 0x000408, "Member 'ABP_KposeBase_C::MaterialPrefix1_不可修改_' has a wrong offset!");

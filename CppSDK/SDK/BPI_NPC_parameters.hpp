...
// Function BPI_NPC.BPI_NPC_C.NPC通用回调事件
// 0x000C (0x000C - 0x0000)
struct BPI_NPC_C_NPC通用回调事件 final
{
public:
...
static_assert(alignof(BPI_NPC_C_NPC通用回调事件) == 0x000004, "Wrong alignment on BPI_NPC_C_NPC通用回调事件");
static_assert(sizeof(BPI_NPC_C_NPC通用回调事件) == 0x00000C, "Wrong size on BPI_NPC_C_NPC通用回调事件");
static_assert(offsetof(BPI_NPC_C_NPC通用回调事件, EventID) == 0x000000, "Member 'BPI_NPC_C_NPC通用回调事件::EventID' has a wrong offset!");
